      ...
      <div className="footer-content">
        <div className="footer-grid">
          <div className="footer-grid-info">
            ...
            <div>
              ...
              <a href="#">
                <h4>Do more than store</h4>
              </a>
              <a href="#">
                <h4>Security</h4>
              </a>
              <a href="#">
                <h4>Advance access</h4>
              </a>
            </div>
          </div>
          <div className="footer-grid-info">
          ...
          <div className="footer-grid-info">
            ...
            <div>
              ...
              <a href="#">
                <h4>Cookies & CCPA preferences</h4>
              </a>
              <a href="#">
                <h4>AI principles</h4>
              </a>
        ...
        <div className="footer-icons">
          <div>
            ...
            >
              <span class="dwg-lazy-icon--large dwg-box dwg-display--inline-block">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  class="dig-UIIcon"
        ...
        <div className="footer-link">
          <button>
            <span>
              ...
              <span class="dwg-box dwg-display--flex dwg-pl--1">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  class="dig-UIIcon dig-UIIcon--standard"
